...
app.get("/", (req, res) => {
  ...
  res.render("index.ejs", { thisYear: year })
});
...
app.post("/submit", (req, res) => {
  ...
  let name = `${adj[Math.floor(Math.random() * adj.length)]} ${noun[Math.floor(Math.random() * noun.length)]}`;
  names.push(name);
  console.log(names);
  res.render("index.ejs", { name: name, thisYear: year, nameList: names });
});
