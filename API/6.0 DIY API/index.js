...
app.get("/jokes/:id", (req, res) => {
  ...
  res.json(jokes.find((data) => data["id"] === parseInt(req.params.id)));
});
...
app.get("/filter", (req, res) => {
  ...
  let filteredJokes = []
  // jokes.forEach((data) => {
  //   if (data.jokeType === req.query.Type) filteredJokes.push(data);
  // });
  filteredJokes = jokes.filter((data) => data.jokeType === req.query.Type);
...
app.put("/jokes/:id", (req, res) => {
  ...
  const searchIndex = jokes.findIndex((data) => data.id == replaceJoke.id);
...
app.patch("/jokes/:id", (req, res) => {
  ...
  jokes.forEach((data) => {
    if (data.id === parseInt(req.params.id)) {
      // if (req.body.text) data.jokeText = req.body.text;
      // if (req.body.type) data.jokeType = req.body.type;
      data.jokeText = req.body.text || data.jokeText;
      data.jokeType = req.body.type || data.jokeType;
    }
  });
  res.json(jokes.find((data) => data["id"] === parseInt(req.params.id)));
});
...
app.delete("/jokes/:id", (req, res) => {
  jokes = jokes.filter((data) => data.id != parseInt(req.params.id));
  res.sendStatus(200);
});
